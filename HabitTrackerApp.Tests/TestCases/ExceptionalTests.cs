...
namespace HabitTrackerApp.Tests.TestCases
{
    public class ExceptionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Habit_ById_NotNull()
        {
            //Arrange
            var res = false;
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Habit_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Delete_Habit_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                habittrackerservice.Setup(repos => repos.DeleteHabit(_Habit.Id)).Returns(id);
        ...
        [Fact]
        public async Task<bool> Testfor_GetAll_Habit_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Invalid_HabitName_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Invalid_HabitNote_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
